<?php
session_start();
require_once "Database/project.sql";
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="fix.php?id=<?php echo $row['id'] ?>&message=<?php 
                            echo $row['nombre'] ?>&licencia=<?php 
                            echo $row['licencia']; ?> " role="button">
